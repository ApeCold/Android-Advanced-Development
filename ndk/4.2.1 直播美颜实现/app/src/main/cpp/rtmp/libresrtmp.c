 ...
 *
 */
 JNIEXPORT jlong JNICALL Java_com_dongnao_livedemo_rtmp_RtmpClient_open
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_dongnao_livedemo_rtmp_RtmpClient_read
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_dongnao_livedemo_rtmp_RtmpClient_write
 ...
 * Signature: ()I
 */
 JNIEXPORT jint JNICALL Java_com_dongnao_livedemo_rtmp_RtmpClient_close
...
JNIEXPORT jstring JNICALL Java_com_dongnao_livedemo_rtmp_RtmpClient_getIpAddr
