...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_core_ColorHelper_NV21TOYUV420SP
...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_core_ColorHelper_YUV420SPTOYUV420P
		(JNIEnv *env, jobject thiz, jbyteArray srcarray, jbyteArray dstarray, jint ySize) {
	unsigned char *src = (unsigned char *) (*env)->GetByteArrayElements(env, srcarray, 0);
	unsigned char *dst = (unsigned char *) (*env)->GetByteArrayElements(env, dstarray, 0);
...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_core_ColorHelper_NV21TOYUV420P
		(JNIEnv *env, jobject thiz, jbyteArray srcarray, jbyteArray dstarray, jint ySize) {
	unsigned char *src = (unsigned char *) (*env)->GetByteArrayElements(env, srcarray, 0);
	unsigned char *dst = (unsigned char *) (*env)->GetByteArrayElements(env, dstarray, 0);
...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_core_ColorHelper_NV21TOARGB
		(JNIEnv *env, jobject thiz, jbyteArray srcarray, jintArray dstarray, jint width,
		 jint height) {
	unsigned char *src = (unsigned char *) (*env)->GetByteArrayElements(env, srcarray, 0);
...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_core_ColorHelper_NV21Transform
		(JNIEnv *env, jobject thiz, jbyteArray srcarray, jbyteArray dstarray, jint srcwidth,
...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_render_GLESRender_NV21TOYUV
		(JNIEnv *env, jobject thiz, jbyteArray srcarray, jbyteArray dstYarray, jbyteArray dstUarray,
...
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_core_ColorHelper_FIXGLPIXEL
...
//rendering
JNIEXPORT void JNICALL Java_com_dongnao_livedemo_render_NativeRender_renderingSurface
	...
	if (window != NULL) {
		...
		if (ANativeWindow_lock(window, &buffer, NULL) == 0) {
			unsigned char *pixels = (unsigned char *) (*env)->GetByteArrayElements(env, pixelsArray,
																				   0);
