...
public class RTMPConfig {
    ...
    public static class FilterMode {
        public static final int HARD = RTMPCoreParameters.FILTER_MODE_HARD;
        public static final int SOFT = RTMPCoreParameters.FILTER_MODE_SOFT;
    }

    public static class RenderingMode {
        public static final int NativeWindow = RTMPCoreParameters.RENDERING_MODE_NATIVE_WINDOW;
        public static final int OpenGLES = RTMPCoreParameters.RENDERING_MODE_OPENGLES;
    }

    public static class DirectionMode {
        public static final int FLAG_DIRECTION_FLIP_HORIZONTAL = RTMPCoreParameters.FLAG_DIRECTION_FLIP_HORIZONTAL;
        public static final int FLAG_DIRECTION_FLIP_VERTICAL = RTMPCoreParameters.FLAG_DIRECTION_FLIP_VERTICAL;
        public static final int FLAG_DIRECTION_ROATATION_0 = RTMPCoreParameters.FLAG_DIRECTION_ROATATION_0;
        public static final int FLAG_DIRECTION_ROATATION_90 = RTMPCoreParameters.FLAG_DIRECTION_ROATATION_90;
        public static final int FLAG_DIRECTION_ROATATION_180 = RTMPCoreParameters.FLAG_DIRECTION_ROATATION_180;
        public static final int FLAG_DIRECTION_ROATATION_270 = RTMPCoreParameters.FLAG_DIRECTION_ROATATION_270;
    }
    ...
    public static RTMPConfig obtain() {
        RTMPConfig res = new RTMPConfig();
