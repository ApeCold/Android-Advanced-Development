...
public class MediaCodecHelper {
    public static MediaCodec createSoftVideoMediaCodec(RTMPCoreParameters coreParameters, MediaFormat videoFormat) {
...
//            }
    ...
    public static MediaCodec createAudioMediaCodec(RTMPCoreParameters coreParameters, MediaFormat audioFormat) {
        //Audio
        MediaCodec result;
    ...
    public static MediaCodec createHardVideoMediaCodec(RTMPCoreParameters coreParameters, MediaFormat videoFormat) {
        videoFormat.setString(MediaFormat.KEY_MIME, "video/avc");
        videoFormat.setInteger(MediaFormat.KEY_WIDTH, coreParameters.videoWidth);
        videoFormat.setInteger(MediaFormat.KEY_HEIGHT, coreParameters.videoHeight);
