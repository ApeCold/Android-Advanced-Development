...
public class CameraHelper {
    ...
    public static boolean configCamera(Camera camera, RTMPCoreParameters coreParameters) {
    ...
    public static void selectCameraFpsRange(Camera.Parameters parameters, RTMPCoreParameters coreParameters) {
    ...
    public static void selectCameraPreviewWH(Camera.Parameters parameters, RTMPCoreParameters coreParameters, Size targetSize) {
    ...
    public static boolean selectCameraColorFormat(Camera.Parameters parameters, RTMPCoreParameters coreParameters) {
