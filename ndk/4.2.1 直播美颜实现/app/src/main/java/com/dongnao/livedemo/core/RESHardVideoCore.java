...
public class RESHardVideoCore implements RESVideoCore {
    ...
    public RESHardVideoCore(RTMPCoreParameters parameters) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case WHAT_RESET_VIDEO: {
                    RTMPCoreParameters newParameters = (RTMPCoreParameters) msg.obj;
        ...
        public void updateCameraIndex(int cameraIndex) {
            synchronized (syncCameraTextureVerticesBuffer) {
                ...
                if (currCamera == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                    directionFlag = resCoreParameters.frontCameraDirectionMode ^ RTMPConfig.DirectionMode.FLAG_DIRECTION_FLIP_HORIZONTAL;
                } else {
