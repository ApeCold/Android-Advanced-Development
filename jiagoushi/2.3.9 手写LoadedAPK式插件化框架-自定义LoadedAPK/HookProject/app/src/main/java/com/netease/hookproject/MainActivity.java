...
//        }
    ...
    public void startTestActivity(View view) {
        // startActivity(new Intent(this, TestActivity.class)); // 上一节课完成的内容
        // startActivity(new Intent(this, Test2Activity.class));

        // 宿主中 启动宿主中的Activity，【宿主启动宿主中的Activity】
//        Intent intent = new Intent();
//        intent.setComponent(new ComponentName("com.netease.hookproject", "com.netease.hookproject.TestActivity"));
//        startActivity(intent);



        // 宿主中  去启动插件里面的PluginActivity -- 【宿主启动插件中的Activity】
        Intent intent2 = new Intent();
        intent2.setComponent(new ComponentName("com.netease.plugin_package", "com.netease.plugin_package.PluginActivity"));
